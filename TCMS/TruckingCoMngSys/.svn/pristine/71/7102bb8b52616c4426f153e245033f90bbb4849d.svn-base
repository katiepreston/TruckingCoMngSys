...
class MaintenanceItemsControllerTest < ActionController::TestCase
  ...
  test "should create maintenance_item" do
    assert_difference('MaintenanceItem.count') do
      post :create, maintenance_item: { maintenance_record_id: @maintenance_item.maintenance_record_id, maintenance_type_id: @maintenance_item.maintenance_type_id, maintenance_type_type: @maintenance_item.maintenance_type_type }
    end
  ...
  test "should update maintenance_item" do
    patch :update, id: @maintenance_item, maintenance_item: { maintenance_record_id: @maintenance_item.maintenance_record_id, maintenance_type_id: @maintenance_item.maintenance_type_id, maintenance_type_type: @maintenance_item.maintenance_type_type }
    assert_redirected_to maintenance_item_path(assigns(:maintenance_item))
  end
